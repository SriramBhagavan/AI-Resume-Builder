...
import api from '../configs/api' // or "../utils/api" depending on folder
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 rounded-lg disabled:bg-gray-100 w-full"
                />
              </div>
              ...
              <div className="space-y-2 mt-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm px-3 py-2 border border-gray-300 rounded-lg resize-none focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none"
