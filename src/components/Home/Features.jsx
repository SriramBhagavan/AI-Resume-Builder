  ...
  return (
   <div id="features" className='flex flex-col items-center justify-center '>
    ...
    <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10  rounded-full px-6 py-1.5">
        ...
        <Title title='Build your resume' description='Our streamed process helps you create a professional resume in minutes with intelligent AI-Powered tools and features.' />
